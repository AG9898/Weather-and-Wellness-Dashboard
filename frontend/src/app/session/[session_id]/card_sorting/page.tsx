...
/**
 * Placeholder card sorting route. The full task UI is implemented in a later
 * task; this page only wires battery routing so the assigned task order can
 * advance to the next cognitive task or to completion without breaking the flow.
 */
