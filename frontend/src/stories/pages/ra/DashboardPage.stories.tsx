...
type DashboardStoryState = "replica" | "loading" | "empty" | "error";
...
function buildMockFetch(state: DashboardStoryState): MockFetchRoute[] {
...
const meta = {
  ...
  parameters: {
    ...
    mockFetch: buildMockFetch("replica"),
  },
...
export const Loading: Story = {
  parameters: {
    mockFetch: buildMockFetch("loading"),
  },
};

export const Empty: Story = {
  parameters: {
    mockFetch: buildMockFetch("empty"),
  },
};

export const Error: Story = {
  parameters: {
    mockFetch: buildMockFetch("error"),
  },
};
