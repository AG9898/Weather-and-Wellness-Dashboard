...
| [`docs/labs/weather-wellness/misokinesia/LOCALIZATION.md`](labs/weather-wellness/misokinesia/LOCALIZATION.md) | Misokinesia locale registry, demographics option keys, per-locale validation overrides, and the EN/KO instrument + UI chrome string catalogue |
